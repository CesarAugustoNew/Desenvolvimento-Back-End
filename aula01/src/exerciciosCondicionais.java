...
public class exerciciosCondicionais {
    ...
    public static void main(String[] args) {
      ...
      //  Exercício 1 — Número Par ou Impar
      ...
      //   Exercício 3 — Maior de Idade
        ...
        String mensagem = (idadeUsuario >= 18) ? "Maior de idade" : "Menor de idade";
      ...
      //   Exercício 5 — Maior entre dois números
        ...
        if (numeroUm > numeroDois) {
            System.out.printf("Numero um maior que numero dois %s > %s", numeroUm, numeroDois);
        } else if (numeroDois > numeroUm) {
            System.out.printf("Numero dois maior que numero um %s > %s", numeroDois, numeroUm);
        } else {
      ...
      //  Exercício 7 — Dia da Semana
       ...
       //       Exercício 8 — Calculadora Simples
        ...
        System.out.println("Digite o primeiro numero: ");
        int numeroCalUm = scanner.nextInt();

        System.out.println("Digite o segundo numero: ");
        int numeroCalDois = scanner.nextInt();
        ...
        switch (operador) {
            case 1:
                int soma = numeroCalUm + numeroDois;
                System.out.printf("A soma dos numeros é %s", soma);
                break;
            case 2 :
                int subtracao = numeroCalUm - numeroCalDois;
                System.out.printf("A subtracao dos numeros é %s", subtracao);
                break;
            case 3 :
                int multiplicacao = numeroCalUm * numeroCalDois;
                System.out.printf("A multiplicação dos numeros é %s", multiplicacao);
                break;
            case 4 :
                double divisao = (double) numeroCalUm / numeroCalDois;
                System.out.printf("A divisão dos numeros é %.2f", divisao);
                break;
            default:
